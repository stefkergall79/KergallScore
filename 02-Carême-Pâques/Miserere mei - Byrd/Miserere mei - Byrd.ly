...
soprano = \relative d'' {
  ...
  r4  a4  c4  d4 | % 18
   ...
   e2  d4  f4 ~ | % 20
  f8 [  e8 ]  d4 ~  d8 [  des16  b16 ]  des4 | % 21
  d1 | % 22
  r4  d2  d4 | % 23
   f2  d2 | % 24
  r4  bes4 ~  bes8 [  c8 ]  d4 | % 25
   es2.  d8 [  c8 ] | % 26
   d4  d2  c4 | % 27
   bes4  a4  bes2 | % 28
   g4  c4  es2 | % 29
  ...
  r2 r4  d4 | % 38
   ...
   c4  d4  bes2 | % 40
   a4  a4  a4  g8 [  bes8 ~ ] | % 41
   bes8 [  a8 ]  g4 ~  g8 [  fis16  e16 ]  fis4 | % 42
   g2 r4  g'4 | % 43
   g4  g4  d4.  es8 | % 44
   f4  g4  es2 | % 45
   d2 r4  f4 | % 46
...
sopranoLyricsOne = \lyricmode {
  ...
  mi -- se -- ri -- cor -- di  -- am, mi -- se -- ri -- cor -- di  -- am tu -- am_;
  Et se -- cun  -- dum mul -- ti -- tu  -- di -- nem
  mi -- se -- ra -- ti -- o -- num tu -- a -- rum
  de -- le in -- i -- qui -- ta  -- tem me -- am, me -- am,
  de  -- le in -- i -- qui -- ta  -- tem me  -- am,
  in -- i -- qui  -- ta- -- tem me -- am,
  de  -- le in -- i -- qui -- ta  -- tem me  -- am,
  de  -- le in -- i -- qui -- ta  -- tem me  -- am,
  in i qui ta  -- tem  -- me -- am.
}
...
tenor = \relative d' {
  ...
  r4  g,4  d'4  e4 | % 17
   f4.  f8  e4  d4 ~ | % 18
   d8 [  des16  b16 ]  des4  d4. -.  d8 | % 19

   e8 [  f8 ]  g4 ~  g8 [  g8 ]  f4 | % 20
   d2  e2 | % 21
  d1 | % 22
  r4  f2  f4 | % 23
   d2  bes4  d4 | % 24
...
bassTwo = \relative g {
  \clef "bass" \numericTimeSignature \time 2/2 \key f \major  g2.  g4 | % 1
   c,2  b2 | % 2
   c2  g'2 | % 3
  c,1 | % 4
  g'1 | % 5
  ...
  r2 r4  g'4 | % 35
   g4  g4  d4.  e8 | % 36
   f4  g4  a4  bes4 ~ | % 37
   bes8 [  a8 ]  g4 ~  g8 [  fis16  e16 ]  fis4 | % 38
   g2 r2 | % 39
