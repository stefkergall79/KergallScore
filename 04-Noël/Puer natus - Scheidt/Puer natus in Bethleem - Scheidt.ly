...
PartPOneVoiceOneLyricsOne = \strophemode 1 ##f \lyricmode {
  ...
  al -- le -- _ lu -- ia, al -- le -- _ lu -- ia. al -- le -- _ lu -- ia.
...
PartPTwoVoiceOneLyricsOne = \strophemode 1 ##f \lyricmode {
  Pu -- er na -- tus in Be -- thle -- em,
  al -- le -- _ lu -- ia, al -- le -- _ lu -- ia, al -- le -- lu -- ia.
  Un -- de gau -- det Je -- ru -- sa -- lem,
  al -- le -- _ lu -- ia, al -- le -- _ lu -- ia, al -- le -- lu -- ia.
}
...
\score {
  ...
  <<
    \new Staff \with {
      ...
      instrumentName = "Solo"
    } \new Voice = "solo" \PartPOneVoiceOne
    \new Lyrics \with {
      \override VerticalAxisGroup.staff-affinity = #CENTER
    } \lyricsto "solo" \PartPOneVoiceOneLyricsOne
    \new Lyrics \with {
      \override VerticalAxisGroup.staff-affinity = #CENTER
    } \lyricsto "solo" \PartPOneVoiceOneLyricsTwo
    \new Lyrics \with {
      \override VerticalAxisGroup.staff-affinity = #CENTER
    } \lyricsto "solo" \PartPOneVoiceOneLyricsThree
  ...
  \new ChoirStaff \with {
      ...
      \new Lyrics \with {
        \override VerticalAxisGroup.staff-affinity = #CENTER
      } \lyricsto "PartPTwoVoiceOne" \PartPTwoVoiceOneLyricsTwo
      \new Lyrics \with {
        \override VerticalAxisGroup.staff-affinity = #CENTER
      } \lyricsto "PartPTwoVoiceOne" \PartPTwoVoiceOneLyricsThree
   
     \new Staff \with {
        \clef bass
      } <<
        \new Voice = "PartPThreeVoiceOne" {\voiceOne \PartPThreeVoiceOne}
        \new Voice = "PartPThreeVoiceTwo" {\voiceTwo \PartPThreeVoiceTwo}
       >>
    >>
  >>
