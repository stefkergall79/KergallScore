...
Les partitions sont écrites en [lilypond](https://lilypond.org/index.html). Pour une compilation sans erreur dès le départ, copiez tous les fichiers du dossier [.utils/](../.utils/) dans le dossier d'inclusion par défaut de lilypond.
...
- Si vous êtes sous MacOS : [abonnement claude.ai](https://claude.ai/upgrade/pro).
- Si vous êtes sous Windows : pauvres fous ! [installer Linux est long mais facile](https://linuxmint.com/edition.php?id=326).
