...
All our source files are free: download them, modify them, tear them apart. For an error-free compilation right out of the box, copy every file from the [.utils/](../.utils/) directory into lilypond's default include folder.
...
```
- If you're on Mac OS: you're loaded, a [Claude](https://claude.ai) subscription will explain the process better than any tutorial.
